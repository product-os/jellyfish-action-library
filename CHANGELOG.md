...
* Update @balena/jellyfish-plugin-product-os from 2.9.4 to 3.0.7 [Renovate Bot]
...
* Fix create session test typos [Josh Bowling]
* Generate an authentication token when creating a new session [edufschmidt]
...
* patch: Update dependency @balena/jellyfish-metrics to ^2.0.18 [Renovate Bot]
...
* patch: Update dependency @balena/jellyfish-mail to ^2.0.159 [Renovate Bot]
...
* patch: Update dependency @balena/jellyfish-queue to ^2.3.1 [Renovate Bot]

## 16.1.3 - 2021-12-27

* patch: Update dependency @balena/jellyfish-test-harness to ^9.1.0 [Renovate Bot]
...
* Export the `actions` module [Carol Schulze]

## 16.0.0 - 2021-12-23

* Export `ActionLibrary` using the `export` statement [Carol Schulze]
...
* Update queue and remove core dependencies, and organize imports [Carol Schulze]
