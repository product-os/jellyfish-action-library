...
module.exports = {
	...
	'action-maintain-contact-account-link': {
		card: require('./actions/action-maintain-contact-account-link'),
		pre: _.noop,
		handler: require('./handlers/action-maintain-contact-account-link').handler
	},
	...
	'action-matchmake-task': {
		card: require('./actions/action-matchmake-task'),
		pre: _.noop,
		handler: require('./handlers/action-matchmake-task').handler
	}
}
